...
export class HomePage {
  // Datos generados en la web mockaroo.com
  ...
  categoria: string;
  sueldo: number;
  enPracticas: boolean = false;
  mostrarEmpleados: boolean = false;
  empleadosSeleccionados: Array<Empleado>;
  op: String;
  ...
  buscar() {
    ...
    this.empleados.forEach(empleado => {
      if (empleado.ciudad.normalize().trim() == this.ciudad.normalize().trim() && empleado.categoria.normalize().trim() == this.categoria.normalize().trim()
        && empleado.practicas == this.enPracticas && empleado.sueldo >= this.sueldo) {
  ...
  buscarAvanzado() {
    ...
    var cadenaBuscarCategoria: string;
    ...
    if (this.categoria == null)
      cadenaBuscarCategoria = "true";
    else
      cadenaBuscarCategoria = "empleado.categoria.normalize().trim()===this.categoria.normalize().trim()";
    ...
    console.log(cadenaBuscarSueldo + " " + cadenaBuscarCiudad + " " + cadenaBuscarCategoria + " ");

    this.empleadosSeleccionados = [];
    this.empleados.forEach(empleado => {
      if (eval(cadenaBuscarCiudad)
        && eval(cadenaBuscarSueldo)
        && eval(cadenaBuscarCategoria)
        && this.enPracticas == empleado.practicas) {
        this.empleadosSeleccionados.push(empleado);
      }
    })
    this.mostrarEmpleados = true;
